...
return [
  ...
  'firebase.sa_file' => __DIR__ . '/../../config/prod/firebase-sa.json',
  ...
  // JWT設定
  'my-auth.private_key' => __DIR__ . '/../../config/prod/jwt-private.pem',
  'my-auth.public_key' => __DIR__ . '/../../config/prod/jwt-public.pem',
